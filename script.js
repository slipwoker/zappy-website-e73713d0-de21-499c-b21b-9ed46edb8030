    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "לוח זמנים לפי שיטת אור החיים תל אביב משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: 'e73713d0-de21-499c-b21b-9ed46edb8030',
                    name: data.name || '',
                    email: data.email || '',
